    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                ...
                <p class="text-gray-400 text-sm">Experience movies like never before with CineBook - your ultimate destination for hassle-free movie ticket booking.</p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="movies.php" class="text-gray-400 hover:text-white transition">Movies</a></li>
                    <li><a href="theaters.php" class="text-gray-400 hover:text-white transition">Theaters</a></li>
                    <li><a href="offers.php" class="text-gray-400 hover:text-white transition">Offers</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    <li class="flex items-start">
                        ...
                        <span>123 Cinema Street, Itahari, Nepal</span>
                    </li>
                    <li class="flex items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 mt-0.5 text-red-500" viewBox="0 0 20 20" fill="currentColor">
